...
def t(label: str, lang: str = "ru") -> str:
    texts = {
        "greeting": {
            "ru": (
    "Это не консультация и не запись.\n\n"
    "Этот бот — продолжение канала\n"
    "«Скрининг на носительство».\n\n"
    "Он нужен не для срочных решений,\n"
    "а чтобы спокойно разобраться,\n"
    "есть ли в вашей ситуации вообще вопрос по генетике\n"
    "или эту тему можно пока закрыть.\n\n"
